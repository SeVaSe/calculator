...
def knopki():
    ...
    # возвести в степень
    btn1 = Button(window, bg='#2ab8fa', fg='white', text='x^?', font=('', 15, 'bold'), command= lambda : input_entry('**', entry))
    btn1.place(x=2, y=70, width=70, height=70)

    # стереть все
    btn2 = Button(window, bg='#fa9819', fg='white', text='C', font=('', 15, 'bold'), command= lambda : clear_entry(entry))
    btn2.place(x=75, y=70, width=70, height=70)

    # удалить один последний символ
    btn3 = Button(window, bg='#fa9819', fg='white', text='del', font=('', 15, 'bold'), command= lambda : delete_znak(entry))
    btn3.place(x=147, y=70, width=70, height=70)

    # +
    btn_plus = Button(window, bg='#2ab8fa', fg='white', text='+', font=('', 20, 'bold'), command= lambda : input_entry('+', entry))
    btn_plus.place(x=219, y=70, width=70, height=70)


    ### вторая строчка кнопок
    # 1
    btn4 = Button(window, bg='black', fg='white', text='1', font=('', 15, 'bold'), command= lambda : input_entry('1', entry))
    btn4.place(x=2, y=142, width=70, height=70)

    # 2
    btn5 = Button(window, bg='black', fg='white', text='2', font=('', 15, 'bold'), command= lambda : input_entry('2', entry))
    btn5.place(x=75, y=142, width=70, height=70)

    # 3
    btn6 = Button(window, bg='black', fg='white', text='3', font=('', 15, 'bold'), command= lambda : input_entry('3', entry))
    btn6.place(x=147, y=142, width=70, height=70)

    # -
    btn_minus = Button(window, bg='#2ab8fa', fg='white', text='-', font=('', 20, 'bold'), command= lambda : input_entry('-', entry))
    btn_minus.place(x=219, y=142, width=70, height=70)


    ### третья строчка кнопок
    # 4
    btn7 = Button(window, bg='black', fg='white', text='4', font=('', 15, 'bold'), command= lambda : input_entry('4', entry))
    btn7.place(x=2, y=214, width=70, height=70)

    # 5
    btn8 = Button(window, bg='black', fg='white', text='5', font=('', 15, 'bold'), command= lambda : input_entry('5', entry))
    btn8.place(x=75, y=214, width=70, height=70)

    # 6
    btn9 = Button(window, bg='black', fg='white', text='6', font=('', 15, 'bold'), command= lambda : input_entry('6', entry))
    btn9.place(x=147, y=214, width=70, height=70)

    # *
    btn_umn = Button(window, bg='#2ab8fa', fg='white', text='x', font=('', 20, 'bold'), command= lambda : input_entry('*', entry))
    btn_umn.place(x=219, y=214, width=70, height=70)


    ### четвертая строчка кнопок
    # 7
    btn7 = Button(window, bg='black', fg='white', text='7', font=('', 15, 'bold'), command= lambda : input_entry('7', entry))
    btn7.place(x=2, y=286, width=70, height=70)

    # 8
    btn8 = Button(window, bg='black', fg='white', text='8', font=('', 15, 'bold'), command= lambda : input_entry('8', entry))
    btn8.place(x=75, y=286, width=70, height=70)

    # 9
    btn9 = Button(window, bg='black', fg='white', text='9', font=('', 15, 'bold'), command= lambda : input_entry('9', entry))
    btn9.place(x=147, y=286, width=70, height=70)

    # ÷
    btn_del = Button(window, bg='#2ab8fa', fg='white', text='÷', font=('', 20, 'bold'), command= lambda : input_entry('/', entry))
    btn_del.place(x=219, y=286, width=70, height=70)


    ### пятая строчка кнопок
    # (
    btn8 = Button(window, bg='black', fg='white', text='(', font=('', 15, 'bold'), command=lambda: input_entry('(', entry))
    btn8.place(x=2, y=358, width=70, height=70)

    # 0
    btn8 = Button(window, bg='black', fg='white', text='0', font=('', 15, 'bold'), command= lambda : input_entry('0', entry))
    ...
    # %
    btn8 = Button(window, bg='#2ab8fa', fg='white', text='%', font=('', 15, 'bold'), command=lambda: input_entry(' %', entry))
    btn8.place(x=219, y=358, width=70, height=70)


    ### шестая строчка кнопок
    # |x|
    btn_persent = Button(window, bg='#2ab8fa', fg='white', text='|x|', font=('', 15, 'bold'), command=lambda: input_entry(' abs', entry))
    btn_persent.place(x=75, y=430, width=70, height=70)

    # sqrt
    btn_sqrt = Button(window, bg='#2ab8fa', fg='white', text='√', font=('', 20, 'bold'), command=lambda: input_entry(' √', entry))
    btn_sqrt.place(x=2, y=430, width=70, height=70)

    # .
    btn9 = Button(window, bg='black', fg='white', text='.', font=('', 20, 'bold'), command= lambda : input_entry('.', entry))
    btn9.place(x=147, y=430, width=70, height=70)

    # =
    btn_umn = Button(window, bg='red', fg='white', text='=', font=('', 20, 'bold'), command= lambda : answer_send(entry))
